...
return new class extends Migration
{
    public function up(): void
    {
        if (!Schema::hasTable('activity_logs')) {
            ...
            // --- BACKFILL HISTORY ---
            // We populate the log with existing data so the report isn't empty.
            
            // Get first admin user ID for attribution (fallback)
            ...
            // 5. Backfill Settings Changes (Generic)
             DB::table('activity_logs')->insert([
                'user_id' => $adminId,
                'action' => 'System Setup',
                'description' => "System installation and initial configuration completed.",
